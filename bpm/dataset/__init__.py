...
def create_dataset(
  ...
  if name == 'market1501':
    im_dir = ospeu('~/Desktop/market1501')
    partition_file = ospeu('~/Desktop/partitions.pkl')

  elif name == 'cuhk03':
    im_type = ['detected', 'labeled'][0]
    im_dir = ospeu(ospj('~/Desktop/cuhk03', im_type, 'images'))
    partition_file = ospeu(ospj('~/Desktop/cuhk03', im_type, 'partitions.pkl'))

  elif name == 'duke':
    im_dir = ospeu('~/Desktop/duke')
    partition_file = ospeu('~/Desktop/dukepartitions.pkl')
